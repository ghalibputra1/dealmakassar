            ...
            <div class="col-lg-3">
                <div class="widget widget_text widget_info">
                    ...
                    <div class="textwidget">
                        <p>Lorem ipsum dolor sit amet, luctus pos semper felis consectetuer hendrerit, im
                ...
                <div id="nav_menu-2" class="widget widget_nav_menu">
                    ...
                    <div class="wrap-menufooter clearfix">
                        <ul class="menu one-half">
                            ...
                            <li class="menu-item"><a href="pricing.php">Price</a></li>
                ...
                <div class="widget widget_listing">
                    ...
                    <ul>
                        <li class="clearfix row">
                            <div class="featured">
                                <a href="#" class="effect"><img src="<?php echo base_url."images/"?>flickr/7.jpg" alt="image"></a>
                            </div>
                        ...
                        <li class="clearfix row">
                            <div class="featured">
                                <a href="#" class="effect"><img src="<?php echo base_url."images/"?>flickr/8.jpg" alt="image"></a>
                            </div>
                            <div class="info-listing">
                ...
                <div class="widget widget_contact">
                    ...
                    <ul class="clearfix">
                        <li>
                            <div class="thumb">
                                <a href="#" class="effect">
                                    <img src="<?php echo base_url."images/"?>flickr/1.jpg" alt="image">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="thumb">
                                <a href="#" class="effect">
                                    <img src="<?php echo base_url."images/"?>flickr/2.jpg" alt="image">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="thumb">
                                <a href="#" class="effect">
                                    <img src="<?php echo base_url."images/"?>flickr/3.jpg" alt="image">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="thumb">
                                <a href="#" class="effect">
                                    <img src="<?php echo base_url."images/"?>flickr/4.jpg" alt="image">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="thumb">
                                <a href="#" class="effect">
                                    <img src="<?php echo base_url."images/"?>flickr/5.jpg" alt="image">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="thumb">
                                <a href="#" class="effect">
                                    <img src="<?php echo base_url."images/"?>flickr/6.jpg" alt="image">
                                </a>
                            </div>
                        </li>
                    </ul>
